...
return [
    ...
    "System Name" => "Berkowits Appointment Booking System",
    "Log In" => "Log In",
    ...
    "Patient Delete Successfully" => "Client Delete Successfully",
    ...
    "Find A Doctor" => "Search Our Center!",
    "Amet consectetur adipisicing elit sed do eiusmod" => "Your time, your way – book appointments in a snap!.",
    "Ex. Name" => "Ex. Center Name, city etc",
    "Category" => "Category",
    "Browse by specialist" => "Browse by concern",
    "View List" => "View List",
    "All Category" => "All Category",
    "Meet Our Professionals" => "Meet Our Professionals",
    "Top Rated Specialists" => "Experience the Best, Expect the Best.",
    "reviews" => "reviews",
    "All Specialist" => "All Centers",
    "Download apps" => "Download apps",
    "For Better Test Download Mobile App" => "For Better Test Download Mobile App",
    "appdescription" => "Transform the way you care for your hair and skin with the Berkowits App – the ultimate platform for expert doctor consultations, delivering personalized, top-tier medical care right to your fingertips.",
    ...
    "Search Best Online Doctors" => "Search Center",
    "Search doctors from our nearby centre" => "Search doctors from our nearby Center",
    "View Doctor Profile" => "View Center Profile",
    "View Doctor Centre Profile" => "View Doctor & Center Profile",
    "Get Instant Doctor Appoinment" => "Get Instant  Appoinment",
    "Submit now" => "Submit now",
    "Logout" => "Logout",
    "Sign in" => "Sign in",
    "Specialist" => "Specialist",
    "Concern" => "Concern",
    "Concern Title" => "Let us know your concern",
    "Join As Doctor" => "Join As Doctor",
    "Search Centre" => "Search Center",
    "Join As Profile" => "Join As Profile",
    "Doctor Login" => "Doctor Login",
    "Employee Login" => "Center Login",
    ...
    "Accept" => "Accept",
    "Complete" => "Complete",
    "Doctor Dashboard" => "Center Dashboard",
    "Total Appointment" => "Total Appointment",
    "Total Review" => "Total Review",
    "Total Order" => "Total Order",
    "New Order" => "New Order",
    "New Appointments" => "New Appointments",
    "Patients Appointments" => "Client Appointments",
    ...
    "About Berkowits" => "About Berkowits",
    "Bring care to your home with one click" => "Bring hair & skin care with one click",
    ...
    "Add Medicine" => "Add Medicine/Products",
    "Edit Medicine" => "Edit Medicine/Products",
    ...
    "Days" => "Days",
    "Enter" => "Enter",
    "Search medicine" => "Search medicine or products",
