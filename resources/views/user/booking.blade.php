         ...
         <div class="col-lg-6 col-md-6 col-sm-12 sidebar-side">
            ...
            <div class="doctors-sidebar">
               <div class="form-widget">
                  ...
                  <form action="<?=env('APP_URL').'booking/'.$data->id?>" method="get" enctype="multipart/form-data">
                        <div class="choose-service">
                           <h4>{{__('Service Information')}}</h4>
                                <div class="form-group">
                                @if(isset($_REQUEST['service']) && empty($_REQUEST['therapist']))
                                    <div class="form-group">
                                        <label>{{__('Service')}}</label>
                                        <input type="text" name="service_name" id="service_name" value="{{ $services->zenoti_service_name}}" placeholder="Enter Service Name" disabled>
                                        <input type="hidden" name="service" id="service" value="{{ $services->zenoti_service_id}}" />
                                    </div>
                                    <div class="form-group">
                                        <div class="select-box">
                                            <select class="form-control"  name="therapist" id="therapist" required>
                                                ...
                                                @foreach ($specilaist['therapists']  as $therapists)
                                                        <option value="{{  $therapists['id'] }}">{{ $therapists['display_name'] }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                ...
                                @elseif(isset($_REQUEST['service']) && isset($_REQUEST['therapist'])&& isset($_REQUEST['date']) )
                                    <?php 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="therapist_name" id="therapist_name" value="{{  $therapist_name}}"" placeholder="" disabled>
                                        <label style="margin-top: 15px;">Selected Date</label>
                                        <input type="text" name="service_date" id="service_date" value="{{$_REQUEST['date']}}" placeholder="Enter Service Name" disabled>
                                        <input type="hidden" name="therapist" id="therapist" value="{{$_REQUEST['therapist']}}" />
                                        <input type="hidden" name="service" id="service" value="{{ $services->zenoti_service_id}}" />
                                        <input type="hidden" name="date" id="date" value="{{$_REQUEST['date']}}" />
                                        ...
                                        <div class="select-box">
                                            <select class="form-control" name="service" id="service" required>
                                                ...
                                                @foreach ($services as $service)
                                                        <option value="{{ $service['zenoti_service_id']}}">{{ $service['zenoti_service_name']}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
