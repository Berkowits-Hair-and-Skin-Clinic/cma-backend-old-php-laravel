                     ...
                     <div class="form-inner">
                        <div class="appointment-time">
                           ...
                           <div class="form-group">
                              <label style="font-weight: bold;">{{__('Choose Slot')}}</label>
                        ...
                        <div class="choose-service">
                           ...
                           <div class="form-group">
                              ...
                              <div class="form-group">
                                 ...
                                 <input type="text" name="service" id="service" value="{{$_REQUEST['service']}}" placeholder="Enter Service Name" required="">
                              </div>
                              @else
                              <div class="form-group">
                              ...
                              <div class="form-group">
                                 ...
                                 <input type="text" name="therapist" id="therapist" value="{{$_REQUEST['specialist']}}" placeholder="Enter Therapist Name" required="">
                              </div>
                              @else
                              <div class="form-group">
                                 <div class="select-box">
