...
@section('content')
    ...
    <div id="map"></div>
  <p id="status"></p>
  <label>Session={{Session::get('lat')}}</label>
                                                ...
                                                <div class="lower-content">
                                                    <ul class="name-box clearfix">
                                                        <li class="name">
                                                            <h3>
                                                            @if (empty(Session::has('user_id')))
                                                                <a onclick="pleaselogin()" id="show_book" href="#">{{ $dl->name }}</a>
                                                                
                                                            @else
                                                                <a href="{{ url('booking') . '/' . $dl->id }}">{{ $dl->name }}</a>
                                                            </h3>
                                                            @endif
                                                        </li>
                                                        <!-- <li><i class="icon-Trust-1"></i></li>
                                                    ...
                                                    <!--<div class="rating-box clearfix">
                                                        <ul class="rating clearfix">
                                                            ...
                                                            @else
                                                                <a href="{{ url('booking') . '/' . $dl->id }}">({{ $dl->totalreview }})</a>
                                                            </h3>
                                                            @endif
                                                    ...
                                                    <div align="center" class="lower-box clearfix">
                                                        ...
                                                        @if(Session::has("user_id"))
                                                            ...
                                                            <a href="{{ url('booking') . '/' . $dl->id }}">{{ __('Book Now') }}</a>
                                                        @else
                                                            <a onclick="pleaselogin()" id="show_book" href="#">{{ __('Book Now') }}</a>
