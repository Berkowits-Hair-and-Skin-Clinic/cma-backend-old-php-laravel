            ...
            <div class="add-listing change-password">
               <div class="single-box">
                  ...
                  <div class="inner-box">
                     ...
                     <form action="{{url('bookappointmentstep2')}}" method="post" enctype="multipart/form-data">
                        {{csrf_field()}}
                                 ...
                                 <div class="select-box">
                                       <select name="center" class="form-control">
                                          ...
                                          @foreach ($centers['centers'] as $center)
                                                <option value="{{ $center['id'] }}">{{ $center['address_info']['city'].",".$center['display_name']}}</option>
                                          @endforeach
                                       </select>
                                 </div>
                              </div>
