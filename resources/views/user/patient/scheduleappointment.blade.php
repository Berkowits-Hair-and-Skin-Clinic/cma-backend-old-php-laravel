   ...
   <div class="left-panel">
      <div class="profile-box patient-profile">
         ...
         <ul class="list clearfix">
               ...
               <li><a href="{{url('userpurchaseproduct')}}" class="current"><i class="fas fa-columns"></i>{{__('message.My Purchase')}}</a></li>
               <!--<li><a href="{{url('favouriteuser')}}"><i class="fas fa-heart"></i>{{__('message.Favourite Doctors')}}</a></li>-->
               <li><a href="{{url('viewschedule')}}" class="current"><i class="fas fa-clock"></i>{{__('message.My Calendar')}}</a></li>
