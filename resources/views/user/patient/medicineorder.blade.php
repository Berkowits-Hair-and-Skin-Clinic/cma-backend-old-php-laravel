        ...
        <div class="left-panel">
            <div class="profile-box patient-profile">
                ...
                <ul class="list clearfix">
                    ...
                    <li><a href="{{url('userdashboard')}}"><i class="fas fa-columns"></i>{{__('message.Appointment History')}}</a></li>
                    <li><a href="{{url('usermedicineorder')}}" class="current"><i class="fas fa-columns"></i>{{__('message.My Orders')}}</a></li>
                    <li><a href="{{url('userdashboard')}}"><i class="fas fa-file"></i>{{__('message.My Invoices')}}</a></li>
                                ...
                                <table class="" id="myTable">
                                    <thead class="table-header">
                                        <tr>
                                            ...
                                            <th>{{ __('message.Client') }} {{ __('message.Name') }}</th>
