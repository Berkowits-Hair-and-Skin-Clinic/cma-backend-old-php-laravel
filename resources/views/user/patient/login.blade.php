            ...
            <div class="auto-container">
                <div class="inner-box">
                    <div class="content-box">
                        <div class="title-box">
                            <h3>{{__('Client Login')}}</h3>
                            <a href="{{url('clientregister')}}">{{__('message.Register Now')}}</a>
                        </div>
                        <div class="inner">
                            ...
                            @endif
                            <div id="error"></div>
                            <!--{{ Session::get('user_phone_no') }}-->
                            @if (Session::get('user_id') != '' && Session::get('role_id') == 1)
                                <script type="text/javascript">
                                    window.location = "{{url('/userdashboard')}}";//here double curly bracket
                                </script>
                             @endif
                             @if (Session::get('user_id') != '' && Session::get('role_id') == 2)
                                <script type="text/javascript">
                                    window.location = "{{url('/doctordashboard')}}";//here double curly bracket
                                </script>
                             @endif
                             @if (Session::get('user_id') != '' && Session::get('role_id') == 3)
                                <script type="text/javascript">
                                    window.location = "{{url('/pharmacydashboard')}}";//here double curly bracket
                                </script>
                             @endif
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 form-group message-btn">
                                <a style="width: 100%;" href="{{url('auth/loginbyotp')}}" class="theme-btn-one">Login By OTP <i class="icon-Arrow-Right"></i></a>
                            </div>
