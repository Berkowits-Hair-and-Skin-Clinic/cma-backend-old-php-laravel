      ...
      <div class="content-container">
         <div class="outer-container">
            <div class="feature-content">
               ...
               </h3><a class="theme-btn-one"  style="float: right;" href="{{url('videoconsultationlist')}}" ><i class="fas fa-camera-alt"></i>{{__(' View List')}}</a><br /><br /><hr />
               <div class="row clearfix">
                  <div class="col-xl-3 col-lg-12 col-md-12 feature-block">
                     <div class="feature-block-two">
                        <div class="inner-box">
                           ...
                           <h5>{{__('Total Consultation')}}</h5>
                        </div>
                     </div>
                  </div>
                  <div class="col-xl-3 col-lg-12 col-md-12 feature-block">
                  <a href="{{url('videoconsultationlist?type=4')}}">
                     <div class="feature-block-two">
                        <div class="inner-box">
                           <div class="pattern">
                           ...
                           <h3>{{$totalComplatedConsultation}}</h3>
                           <h5>{{__('Completed')}}</h5>
                        </div>
                     </div>
                     </a>
                  ...
                  <div class="col-xl-3 col-lg-12 col-md-12 feature-block">
                  <a href="{{url('videoconsultationlist?type=5')}}">
                     <div class="feature-block-two">
                        <div class="inner-box">
                           <div class="pattern">
                  ...
                  <div class="col-xl-3 col-lg-12 col-md-12 feature-block">
                     <a href="{{url('videoconsultationlist?type=2')}}">
                        <div class="feature-block-two">
                           <div class="inner-box">
                              <div class="pattern">
                                 <div class="pattern-1" style="background-image: url('{{asset('public/front_pro/assets/images/shape/shape-83.png')}}');"></div>
                              ...
                              <div class="icon-box"><i class="icon-Dashboard-3"></i></div>
                              <h3>{{$totalPendingConsultation}}</h3>
                              <h5>{{__('Pending')}}</h5>
                           </div>
                        </div>
                     </a>
                            ...
                            @foreach($bookdata as $bo)
		                           ...
		                           <tr>
		                              <td>
		                                 ...
		                                 <div class="name-box">
                                       <a href="{{url('appointment_detail',$bo->id)}}">
		                                    <figure class="image">
