                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-xs-8">
                                  ...
                                  <ul class="info-list clearfix">
                                      ...
                                      <li><i class="fas fa-user"></i><a href="#">{{$am->service_therapist_detail}}</a></li>
                            ...
                            <div class="col-lg-3 col-xs-12">
                                <button style="width: 100%;" type="button" class="theme-btn-one" data-toggle="modal" data-target="#add_Prescription">{{__("message.Add Prescription")}}</button><br><br>
                                <button style="width: 100%;" type="button" class="theme-btn-one" data-toggle="modal" data-target="#add_report">{{__("message.Add Report")}}</button>
                            </div>
                        </div>
                        <hr />
                        <div class="row pt-4">

                            <h4 class="pl-3">{{__("Prescription Details")}}</h4>
