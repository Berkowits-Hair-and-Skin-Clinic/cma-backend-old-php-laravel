      ...
      <div class="content-container">
         <div class="outer-container">
            ...
            <div class="doctors-appointment">
               <div class="title-box">
                  <!--<?php echo e(var_dump($zenotiResponse)); ?>-->
                     ...
                     <table class="doctors-table">
                        ...
                        <tbody>
                           ...
                           <tr >
                              ...
                              <td>
                                 <p><?php echo e($bdata->doctorls->phoneno); ?></p>
                              </td>
                              <td>
                              ...
                              <td>
                                  <?php if($bdata->status=='2'||$bdata->status=='3'||$bdata->status=='1'): ?>
                                      <button type="button" class="btn btn-danger" onclick="reject_record('<?php echo e($bdata->id); ?>')"><?php echo e(__("message.Reject")); ?></button>
                                  <?php endif; ?>
                              </td>
                ...
                for (var j = 0; j < medicines[i].time.length; j++) {
                    ...
                    $("#m_data").append(
                          '<div class="container m-2">' +
                            ...
                            '</div>' +
                            '<div class="row">' +
                              '<div><?php echo e(__("message.Consume it for")); ?> ' + medicines[i].repeat_days + ' <?php echo e(__("message.Days")); ?></div>' +
                            '</div>' +
                          '</div>' +
                           '<hr>'
                        );
...
<?php echo $__env->make('user.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/berkowits/cma-backend/resources/views/user/patient/dashboard.blade.php ENDPATH**/ ?>