   ...
   <div class="left-panel">
      <div class="profile-box patient-profile">
         ...
         <ul class="list clearfix">
               ...
               <li><a href="<?php echo e(url('userpurchaseproduct')); ?>" class="current"><i class="fas fa-columns"></i><?php echo e(__('message.My Purchase')); ?></a></li>
               <!--<li><a href="<?php echo e(url('favouriteuser')); ?>"><i class="fas fa-heart"></i><?php echo e(__('message.Favourite Doctors')); ?></a></li>-->
               <li><a href="<?php echo e(url('viewschedule')); ?>" class="current"><i class="fas fa-clock"></i><?php echo e(__('message.My Calendar')); ?></a></li>
...
<?php echo $__env->make('user.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/berkowits/cma-backend/resources/views/user/patient/scheduleappointment.blade.php ENDPATH**/ ?>