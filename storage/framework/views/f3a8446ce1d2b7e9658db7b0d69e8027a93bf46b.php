        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="mb-0"><?php echo e(__('message.save')); ?> <?php echo e(__('Center/Doctor')); ?></h4>
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(url('admin/updatedoctor')); ?>" class="needs-validation" method="post"
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="name"><?php echo e(__('Center_Id')); ?><span
                                                class="reqfield">*</span></label>
                                        <input type="text" class="form-control"
                                            placeholder='<?php echo e(__('zenoti_Center_Id')); ?>' id="zenoti_Center_Id"
                                            name="zenoti_Center_Id" required=""
                                            value="<?php echo e(isset($data->center_id) ? $data->center_id : ''); ?>">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="name"><?php echo e(__('Zenoti_Employee_Id(blank for center)')); ?><span
                                                class="reqfield">*</span></label>
                                        <input type="text" class="form-control"
                                            placeholder='<?php echo e(__('Zenoti_Employee_Id')); ?>' id="zenoti_employee_Id"
                                            name="zenoti_employee_Id"
                                            value="<?php echo e(isset($data->zenoti_id) ? $data->zenoti_id : ''); ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label for="name"><?php echo e(__('Unique Speciality String')); ?><span
                                                class="reqfield">*</span></label>
                                        <input type="text" class="form-control"
                                            placeholder='<?php echo e(__('Speciality String')); ?>' id="speciality_string"
                                            name="speciality_string" required=""
                                            value="<?php echo e(isset($data->speciality) ? $data->speciality : ''); ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <?php echo e(isset($data->address) ? $data->address : ''); ?>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/berkowits/cma-backend/resources/views/admin/doctor/savedoctor.blade.php ENDPATH**/ ?>