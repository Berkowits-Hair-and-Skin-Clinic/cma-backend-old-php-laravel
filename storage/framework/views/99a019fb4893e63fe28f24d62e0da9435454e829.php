<?php $__env->startSection('title'); ?>
    <?php echo e(__('message.User Report')); ?>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0"><?php echo e(__('message.User Report')); ?></h4>
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item active"><?php echo e(__('message.User Report')); ?></li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                        ...
                        <h4 class="card-title">
                            <?php if(Request::get('data_filter')): ?>
                                <?php if($total == null): ?>
                                    <?php echo e(__('message.User not found')); ?>

                                <?php else: ?>
                                    <?php echo e(__('message.Total user register are')); ?> <?php echo e($total); ?>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/berkowits/cma-backend/resources/views/admin/report/user.blade.php ENDPATH**/ ?>