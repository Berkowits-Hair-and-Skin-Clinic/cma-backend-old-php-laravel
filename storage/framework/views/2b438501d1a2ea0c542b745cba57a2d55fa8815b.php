...
<?php echo e(__('Center Employees')); ?>
   ...
   <div class="left-panel">
      <div class="profile-box">
         ...
         <ul class="list clearfix">
               ...
               <li><a href="<?php echo e(url('videoconsultationlist')); ?>" ><i class="fas fa-calendar-alt"></i><?php echo e(__('Video Consultation')); ?></a></li>
               <li><a href="<?php echo e(url('doctorappointment')); ?>" ><i class="fas fa-calendar-alt"></i><?php echo e(__('message.Appointment')); ?></a></li>
               <li><a href="<?php echo e(url('center_employees')); ?>" class="current"><i class="fas fa-calendar-alt"></i><?php echo e(__('Employees')); ?></a></li>
      ...
      <div class="content-container">
         <div class="outer-container">
            ...
            <div class="doctors-appointment">
               <div class="title-box">
                  <h3><?php echo e(__('Our Employees')); ?></h3>
                   <div class="btn-box col-md-6 tdr"><a href="javascript::void(0)" class="theme-btn-one" data-toggle="modal" data-target="#addaddress"><i class="icon-image" ></i><?php echo e(__("Add Employee")); ?></a></div>
               </div>
                     ...
                     <table class="doctors-table">
                        <thead class="table-header">
                           <tr>
                              ...
                              <th style="text-align: left;"><?php echo e(__("job_info")); ?></th>
                           </tr>
                        </thead>
                        <tbody style="padding: 10px;">
                           <?php if(count($employees)>0): ?>
                              <?php $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dh): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                       <td style="padding: 10px;text-align: left;"><?php echo e($dh['personal_info']['name']); ?></td>
                                       <td style="padding: 10px;text-align: left;"><?php echo e($dh['job_info']['name']); ?></td>
                                    </tr>
                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                           <?php else: ?>
                           <tr>
                                       <td style="text-align: center;"></td>
                                       <td style="text-align: center;"> <p><?php echo e(__("message.No Employees")); ?></p></td>
                                       <td style="text-align: center;"></td>
                                       <td style="text-align: center;"></td>
                                    </tr>
   ...
   <div class="modal-dialog modal-lg">
      <div class="modal-content">
         ...
         <div class="modal-header">
            <h4 class="modal-title"><?php echo e(__("Add Employee")); ?></h4>
         ...
         <button type="submit" id="address_submit_button" class="btn btn-success"><?php echo e(__("Add")); ?></button>
...
<?php echo $__env->make('user.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/berkowits/cma-backend/resources/views/user/doctor/employees.blade.php ENDPATH**/ ?>