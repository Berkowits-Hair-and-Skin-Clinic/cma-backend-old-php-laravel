        ...
        <div class="left-panel">
            <div class="profile-box patient-profile">
                ...
                <ul class="list clearfix">
                    ...
                    <li><a href="<?php echo e(url('usermedicineorder')); ?>" class="current"><i class="fas fa-columns"></i><?php echo e(__('message.My Orders')); ?></a></li>
                    <li><a href="<?php echo e(url('userdashboard')); ?>"><i class="fas fa-file"></i><?php echo e(__('message.My Invoices')); ?></a></li>
                                ...
                                <table class="" id="myTable">
                                    <thead class="table-header">
                                        <tr>
                                            ...
                                            <th><?php echo e(__('message.Client')); ?> <?php echo e(__('message.Name')); ?></th>
...
<?php echo $__env->make('user.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/berkowits/cma-backend/resources/views/user/patient/medicineorder.blade.php ENDPATH**/ ?>