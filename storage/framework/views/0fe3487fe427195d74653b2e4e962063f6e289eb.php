            ...
            <div class="add-listing change-password">
               <div class="single-box">
                  ...
                  <div class="inner-box">
                     ...
                     <form action="<?php echo e(url('bookappointmentstep2')); ?>" method="post" enctype="multipart/form-data">
                           ...
                           <div class="form-group">
                                 <div class="select-box">
                                       <select name="center" class="form-control">
                                          <option value=""><?php echo e(__('Select Center')); ?></option>
                                          <?php $__currentLoopData = $centers['centers']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $center): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($center['id']); ?>"><?php echo e($center['address_info']['city'].",".$center['display_name']); ?></option>
...
<?php echo $__env->make('user.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/berkowits/cma-backend/resources/views/user/patient/bookappointment.blade.php ENDPATH**/ ?>