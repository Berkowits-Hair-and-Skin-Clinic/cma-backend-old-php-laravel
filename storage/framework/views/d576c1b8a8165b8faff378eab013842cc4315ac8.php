      ...
      <div class="profile-box">
         ...
         <div class="profile-info">
            <ul class="list clearfix">
               ...
               <li><a href="<?php echo e(url('paymenthistory')); ?>"  class="current"><i class="fas fa-user"></i><?php echo e(__('message.Payment History')); ?></a></li>
...
<?php echo $__env->make('user.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/berkowits/cma-backend/resources/views/user/doctor/paymenthistory.blade.php ENDPATH**/ ?>