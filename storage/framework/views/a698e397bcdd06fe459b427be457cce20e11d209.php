                  ...
                  <div class="choose-service">  
                                       <label>Selected Service</label>
                                        <input type="text" name="service_name" id="service_name" value="<?php echo e($service_name); ?>" placeholder="Enter Service Name" disabled>
                                          ...
                                          <input type='text' value="<?php echo e($_REQUEST['date']); ?>"  name='selected_date' id='selected_date' />
                                          <!--<input class="dateForSlots" type="text" value="<?php echo e($service_date); ?>" name="date"  id="date" value="<?php echo e(date('Y/m/d')); ?>" id="datepicker" required>
...
<?php echo $__env->make('user.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/berkowits/cma-backend/resources/views/user/booking_firsttimeuser.blade.php ENDPATH**/ ?>