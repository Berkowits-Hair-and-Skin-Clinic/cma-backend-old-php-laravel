            ...
            <div class="auto-container">
                <div class="inner-box">
                    <div class="content-box">
                        <div class="title-box">
                            <h3><?php echo e(__('Verify OTP')); ?></h3>
                            <a href="<?php echo e(url('patientlogin')); ?>"><?php echo e(__('message.Already a User')); ?></a>
                        </div>
                        <div class="inner">
                             <form action="<?php echo e(url('postloginuserotp')); ?>" method="post" class="registration-form">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                                        ...
                                        <input type="hidden" name="zenoti_id" value="<?php echo e($zenoti_id); ?>">
                                        <input type="hidden" name="center_id" value="<?php echo e($center_id); ?>">
                                    </div>
                                   
                                    <div class="col-lg-12 col-md-12 col-sm-12 form-group message-btn">
                                        <button type="submit" class="theme-btn-one"><?php echo e(__('Verify')); ?><i class="icon-Arrow-Right"></i></button>
                                    </div>
                                </div>
                            </form>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('user.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/berkowits/cma-backend/resources/views/user/patient/verifyotp.blade.php ENDPATH**/ ?>