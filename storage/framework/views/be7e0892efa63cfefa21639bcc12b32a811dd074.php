            ...
            <div class="auto-container">
                <div class="content-box">
                    <div class="form-inner clearfix">
                        <form action="<?php echo e(url('searchcentre')); ?>" method="get">
                            <div class="form-group clearfix">

                                <input type="text" name="term" value="<?php echo e($term); ?>" id="term" placeholder="Ex. <?php echo e(__('message.Pharmacy')); ?> <?php echo e(__('message.Name')); ?>" required="">
                                <?php if(!empty($type)): ?>
                                    ...
                                    <div class="clinic-block-one">
                                        <div class="inner-box">
                                            ...
                                            <figure class="image-box">
                                                <?php if($dl->image!=""): ?>
                                                <img src="<?php echo e(asset('public/upload/doctors').'/'.$dl->image); ?>" alt="" style="height: 155px;">
                                                <?php else: ?>
                                                  <img src="<?php echo e(asset('public/upload/doctors/defaultpharmacy.png')); ?>" alt="" style="height: 155px;">
                                                <?php endif; ?>
                                            ...
                                            <div class="content-box">
                                                ...
                                                <ul class="name-box clearfix">
                                                    <li class="name"><h3><a href="<?php echo e(url('viewpharmacy').'/'.$dl->id); ?>"><?php echo e($dl->name); ?></a></h3></li>
                                                ...
                                                <div class="rating-box clearfix">
                                                    <ul class="rating clearfix">
                                                        ...
                                                        <li><a href="<?php echo e(url('viewpharmacy').'/'.$dl->id); ?>">(<?php echo e($dl->totalreview); ?>)</a></li>
                                                    </ul>
                                                    <div class="link"><a href="<?php echo e(url('viewpharmacy').'/'.$dl->id); ?>"><?php echo e($dl->working_time); ?></a></div>
                                                </div>
                                                <div class="location-box">
                                                    <p><i class="fas fa-map-marker-alt"></i><?php echo e(substr($dl->address,0,38)); ?></p>
                                                </div>
                                                <div class="btn-box"><a href="<?php echo e(url('viewpharmacy').'/'.$dl->id); ?>"><?php echo e(__('message.Visit Now')); ?></a></div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="team-block-three">
                                                <div class="inner-box">
                                                    <figure class="image-box">
                                                        ...
                                                        <?php else: ?>
                                                            <img src="<?php echo e(asset('public/upload/doctors/defaultpharmacy.png')); ?>" alt="" style="height: 245px;">
                                                        <?php endif; ?>
                                                          <?php if($dl->is_fav=='0'): ?>
                                                       <?php if(empty(Session::has("user_id"))): ?>
                                                       <a href="<?php echo e(url('patientlogin')); ?>" id="favdoc<?php echo e($dl->id); ?>">
                                                       <?php else: ?>
                                                       <a href="javascript:userfavorite1('<?php echo e($dl->id); ?>')" id="favdoc1<?php echo e($dl->id); ?>">
                                                       <?php endif; ?>
                                                       <?php else: ?>
                                                       <a href="javascript:userfavorite1('<?php echo e($dl->id); ?>')" class="activefav" id="favdoc1<?php echo e($dl->id); ?>">
                                                       <?php endif; ?>
                                                         <i class="far fa-heart"></i></a>
                                                    </figure>
                                                    <div class="lower-content">
                                                        ...
                                                        <div class="lower-box clearfix">
                                                            ...
                                                            <a href="<?php echo e(url('viewpharmacy').'/'.$dl->id); ?>"><?php echo e(__('message.Visit Now')); ?></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
<script type="text/javascript">
    function serachsep(val){
         ...
         if(term==""){
                if(val!=""){
                    window.location.href='<?php echo e(url("searchpharmacy")); ?>'+'?type='+val;
                }
         }else{
            window.location.href='<?php echo e(url("searchpharmacy")); ?>'+'?type='+val+"&term="+term;
         }
...
<?php echo $__env->make('user.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/berkowits/cma-backend/resources/views/user/allpharmacy.blade.php ENDPATH**/ ?>