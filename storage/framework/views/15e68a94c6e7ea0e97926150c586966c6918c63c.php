            ...
            <div class="content-container">
                <div class="outer-container">
                    <div class="doctors-appointment">
                        <div class="title-box">
                            <h3><?php echo e(__('Purchase Order')); ?></h3>
                        </div>
                        <div class="doctors-list m-3">
                            <div class="table-outer">
                                <table class="" id="myTable">
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $productsData['products']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td><?php echo e($product['center']['name']); ?></td>
                                                <td>
                                                    <p><?php echo e($product['name']); ?></p>
                                                </td>
                                                <td><?php echo e($product['sale_date']); ?></td>
                                                <td><?php echo e($product['price_paid']); ?></td>
                                                <td><?php echo e($product['invoice']['invoice_number']); ?></td>
...
<?php echo $__env->make('user.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/berkowits/cma-backend/resources/views/user/patient/purchase.blade.php ENDPATH**/ ?>