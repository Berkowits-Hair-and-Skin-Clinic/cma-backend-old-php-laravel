                     ...
                     <div class="form-inner">
                        <div class="appointment-time">
                           ...
                           <div class="form-group">
                              <label style="font-weight: bold;"><?php echo e(__('Choose Slot')); ?></label>
                        ...
                        <div class="choose-service">
                           ...
                           <div class="form-group">
                              ...
                              <div class="form-group">
                                 ...
                                 <input type="text" name="service" id="service" value="<?php echo e($_REQUEST['service']); ?>" placeholder="Enter Service Name" required="">
                              </div>
                              <?php else: ?>
                              <div class="form-group">
                              ...
                              <?php endif; ?>
                              <?php if(isset($_REQUEST['specialist'])): ?>
                              <div class="form-group">
                                 <label><?php echo e(__('Therapist')); ?></label>
                                 <input type="text" name="therapist" id="therapist" value="<?php echo e($_REQUEST['specialist']); ?>" placeholder="Enter Therapist Name" required="">
                              </div>
                              <?php else: ?>
                              <div class="form-group">
                                 <div class="select-box">
                           ...
                           <div class="form-group">
                              ...
                              <input type="text" name="phone_no" id="phone_no" value="<?php echo e(Session::get("user_phone_no")); ?>" placeholder="<?php echo e(__('message.Enter Your Phone number')); ?>" required="">
                           </div>
                           <div class="form-group">
                            ...
                            <div id="cod_div" style="display:none;">
                                <form action="<?php echo e(url('makeappointment')); ?>" method="post" id="payment-form">
                                   <?php echo e(csrf_field()); ?>
                                    ...
                                    <input type="hidden" name="service" id="service_3">
                                    <input type="hidden" name="therapist" id="therapist_3">
   ...
   function changeform(val){
      ...
      if(phone_no!=""&&date!=""&&message!=""&& slot !== undefined){
            ...
            if($("#payment_type_cod").prop("checked")==true){
                 ...
                 $("#slot_3").val(slot);
                 $("#service_3").val(service);
                 $("#therapist_3").val(therapist);
            }
...
<?php echo $__env->make('user.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/berkowits/cma-backend/resources/views/user/viewdoctor.blade.php ENDPATH**/ ?>