               ...
               <div class="form-inner">
                  <form action="<?php echo e(url('searchdoctor')); ?>" method="get">
                     <div class="form-group">
                        <input type="text" name="query" placeholder="<?php echo e(__('message.Ex. Name')); ?>" required="">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('user.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/berkowits/cma-backend/resources/views/user/home.blade.php ENDPATH**/ ?>