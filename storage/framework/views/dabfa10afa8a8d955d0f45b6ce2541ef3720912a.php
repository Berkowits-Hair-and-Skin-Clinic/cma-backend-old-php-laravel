    ...
    <div class="main-content">
        <div class="page-content">
            <div class="container-fluid">
                ...
                <div class="row mb-3">
                    <a href="<?php echo e(url('admin/video_consultation_list')); ?>"><div class="col-xl-2 col-lg-4 col-md-6 mb-4">
                        <div class="card h-100">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-uppercase mb-1">
                                            <?php echo e(__('Video Consultation')); ?></div>
                                        <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e($totalvc); ?></div>
                    ...
                    <a href="<?php echo e(url('admin/ai_analysis_list')); ?>"><div class="col-xl-2 col-lg-4 col-md-6 mb-4">
                        <div class="card h-100">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-uppercase mb-1">
                                            <?php echo e(__('AI Analysis')); ?></div>
                                        <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e($dashboard_counters['totalai_analysis']); ?></div>
                                        <div class="mt-2 mb-0 text-muted text-xs">
                                        </div>
                                    </div>
                                    <div class="col-auto">
                    ...
                    <a href="<?php echo e(url('admin/payment_by_link')); ?>"><div class="col-xl-2 col-lg-4 col-md-6 mb-4">
                        <div class="card h-100">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-uppercase mb-1">
                                            <?php echo e(__('PayByLink')); ?></div>
                                        <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e($dashboard_counters['total_pay_by_link']); ?></div>
                                        <div class="mt-2 mb-0 text-muted text-xs">
                                        </div>
                                    </div>
                                    <div class="col-auto">
                        ...
                        <div class="card h-100">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-uppercase mb-1">
                                            <?php echo e(__('CMA APP Booking')); ?></div>
                        ...
                        <div class="card h-100">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-uppercase mb-1">
                                            <?php echo e(__('CMA Web Booking')); ?></div>
                                        <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e($totalappointment); ?></div>
                                        <div class="mt-2 mb-0 text-muted text-xs">
                                        </div>
                                    </div>
                        ...
                        <div class="card h-100">
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-uppercase mb-1">
                                            <?php echo e(__('Total Doctors + Center')); ?>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/berkowits/cma-backend/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>