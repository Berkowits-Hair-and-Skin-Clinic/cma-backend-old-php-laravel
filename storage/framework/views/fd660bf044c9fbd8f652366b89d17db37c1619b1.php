        ...
        <div class="auto-container">
            <div class="inner-box">
                <div class="content-box">
                    <div class="title-box">
                        <h3 id="aa2"><?php echo e(__('message.Employee Login')); ?></h3>
                        <!-- Commented by Shak on 6th Dec 2024, Center/Doctor can be added from Admin side -->
                        ...
                        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link  active" id="pills-home-tab" data-toggle="pill" href="#pills-home"
                                    ...
                                    aria-selected="true"><?php echo e(__('message.Specialist')); ?></a>
                            </li>
                            <li class="nav-item">
...
<?php echo $__env->make('user.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/berkowits/cma-backend/resources/views/user/doctor/login.blade.php ENDPATH**/ ?>