                    ...
                    <ul class="navbar-nav <?php if(__('message.RTL') == 1): ?> ml-auto <?php endif; ?>"
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="<?php echo e(url('local/en')); ?>">
                                    
                                    <div class="font-weight-bold">
                                        <div><?php echo e(__('message.english')); ?></div>
                                    </div>
                                </a>
                                <a class="dropdown-item d-flex align-items-center" href="<?php echo e(url('local/ar')); ?>">
                                    
                                    <div class="font-weight-bold">
                                        <div><?php echo e(__('message.arabic')); ?></div>
                                    </div>
                                </a>
                                <a class="dropdown-item d-flex align-items-center" href="<?php echo e(url('local/fr')); ?>">
                                    
                                    <div class="font-weight-bold">
                                        <div><?php echo e(__('message.french')); ?></div>
                                    </div>
                                </a>
                                <a class="dropdown-item d-flex align-items-center" href="<?php echo e(url('local/es')); ?>">
                                    
                                    <div class="font-weight-bold">
                                        <div><?php echo e(__('message.spanish')); ?></div>
                                    </div>
                                </a>
                                <a class="dropdown-item d-flex align-items-center" href="<?php echo e(url('local/pt')); ?>">
...
<?php /**PATH E:\xampp\htdocs\rutik\live\bookappointment__medical\resources\views/admin/layout.blade.php ENDPATH**/ ?>