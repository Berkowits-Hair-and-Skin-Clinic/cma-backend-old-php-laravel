...
<?php $__env->startSection('content'); ?>
    ...
    <div id="map"></div>
  <p id="status"></p>
  <label>Session=<?php echo e(Session::get('lat')); ?></label>
                                                ...
                                                <div class="lower-content">
                                                    <ul class="name-box clearfix">
                                                        <li class="name">
                                                            <h3>
                                                            <?php if(empty(Session::has('user_id'))): ?>
                                                                <a onclick="pleaselogin()" id="show_book" href="#"><?php echo e($dl->name); ?></a>
                                                                
                                                            <?php else: ?>
                                                                <a href="<?php echo e(url('booking') . '/' . $dl->id); ?>"><?php echo e($dl->name); ?></a>
                                                            </h3>
                                                            <?php endif; ?>
                                                        </li>
                                                        <!-- <li><i class="icon-Trust-1"></i></li>
                                                    ...
                                                    <!--<div class="rating-box clearfix">
                                                        <ul class="rating clearfix">
                                                            ...
                                                            <?php else: ?>
                                                                <a href="<?php echo e(url('booking') . '/' . $dl->id); ?>">(<?php echo e($dl->totalreview); ?>)</a>
                                                            </h3>
                                                            <?php endif; ?>
                                                    ...
                                                    <div align="center" class="lower-box clearfix">
                                                        ...
                                                        <?php if(Session::has("user_id")): ?>
                                                            ...
                                                            <a href="<?php echo e(url('booking') . '/' . $dl->id); ?>"><?php echo e(__('Book Now')); ?></a>
                                                        <?php else: ?>
                                                            <a onclick="pleaselogin()" id="show_book" href="#"><?php echo e(__('Book Now')); ?></a>
...
<?php echo $__env->make('user.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/berkowits/cma-backend/resources/views/user/searchdoctor.blade.php ENDPATH**/ ?>