                  ...
                  <div class="card-body">
                     ...
                     <form action="<?php echo e(url('admin/updateaccount')); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                           ...
                           <input type="text" class="form-control" id="email" name="email" placeholder='<?php echo e(__("message.Enter Email Address")); ?>' value="<?php echo e($userdata->email); ?>" required >
                        </div>
                        <div class="form-group">
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/berkowits/cma-admin/resources/views/admin/profile.blade.php ENDPATH**/ ?>