...
<label>Session=<?php echo e(Cookie::get('latitude')); ?></label>
<section class="page-title-two">
    <div class="title-box centred bg-color-2">
       ...
       <div class="auto-container">
          <div class="title">
             <!-- <h1><?php echo e(__('message.Concern Title')); ?></h1> -->
         ...
         <div class="col-lg-4 col-md-6 col-sm-6 col-6 category-block">
            <div class="category-block-one wow fadeInUp animated animated animated" data-wow-delay="00ms" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 0ms; animation-name: fadeInUp;">
               <div class="inner-box">
                  ...
                  <figure class="icon-box"><img src="<?php echo e(asset('public/upload/services').'/'.$d->icon); ?>"  style="height: 150px;width: 100%;" alt=""></figure>
                  <h3><a href="<?php echo e(url('searchcenterall?query=').$query); ?>"><?php echo e($d->name); ?></a></h3>
                  <div class="link"><a href="<?php echo e(url('searchcenterall?type=').$d->id); ?>"><i class="icon-Arrow-Right"></i></a></div>
                  <div class="btn-box"><a href="<?php echo e(url('searchcenterall?query=').$query); ?>" class="theme-btn-one"><?php echo e(__('view nearby center')); ?><i class="icon-Arrow-Right"></i></a></div>
               </div>
            </div>
         </div>
...
<?php $__env->startSection('footer'); ?>
   ...
   <script type="text/javascript">
      ...
      function filterbyconcern(val) {
            window.location.href = '<?php echo e(url('viewspecialist')); ?>' + '?filterby=' + val;
...
<?php echo $__env->make('user.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/berkowits/cma-backend/resources/views/user/viewspecialist.blade.php ENDPATH**/ ?>