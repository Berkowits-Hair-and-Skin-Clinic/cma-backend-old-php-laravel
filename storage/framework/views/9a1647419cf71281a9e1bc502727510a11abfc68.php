                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form action="<?php echo e(url('admin/edit_app_privacy')); ?>" method="post" enctype="multipart/form-data">
                              ...
                              <button name="update_about" type="submit" class="btn btn-md btn-success "><?php echo e(__("message.Submit")); ?></button>
                            </form>
                          </div>
                        </div>
                      </div>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\rutik\live\bookappointment__medical\resources\views/admin/privecy-app.blade.php ENDPATH**/ ?>