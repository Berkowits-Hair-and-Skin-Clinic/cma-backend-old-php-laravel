         ...
         <div class="outer-container">
            <div class="add-listing change-password">
               <div class="single-box">
                  <div class="title-box">
                     <h3><?php echo e(__('My Profile Details')); ?></h3>
                  </div>
                  <div class="inner-box">
                        ...
                        <div class="row clearfix">
                           ...
                           <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                                       <label>ZenotiID: <?php echo e(Session::get('zenoti_id')); ?></label>
                                       <label>Name:<?php echo e($zenotidata['personal_info']['first_name']." ".$zenotidata['personal_info']['last_name']); ?></label>
                                       <label>Email:<?php echo e($zenotidata['personal_info']['email']); ?></label>
                                       <label>Phone:<?php echo e($zenotidata['personal_info']['mobile_phone']['number']); ?></label>
                                    </div>
                           ...
                           <div class="col-lg-12 col-md-6 col-sm-12 form-group">
                              ...
                              <input disabled type="text" name="name" placeholder="<?php echo e(__('message.Enter Your First Name')); ?>" required="" value="<?php echo e(isset($userdata->name)?$userdata->name:''); ?>">
                           </div>
                           <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                              <label><?php echo e(__('message.Phone no')); ?></label>
                              <input disabled type="text" name="phone" placeholder="<?php echo e(__('message.Enter Phone')); ?>" value="<?php echo e(isset($userdata->phone)?$userdata->phone:''); ?>" required="">
                           </div>
                           <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                              <label><?php echo e(__('message.Email')); ?></label>
                              <input disabled type="email" name="email" placeholder="<?php echo e(__('message.Enter Email Address')); ?>" required="" value="<?php echo e(isset($userdata->email)?$userdata->email:''); ?>">
                           </div>
                        </div>
                  </div>
               </div>
...
<?php echo $__env->make('user.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/berkowits/cma-backend/resources/views/user/patient/editprofile.blade.php ENDPATH**/ ?>