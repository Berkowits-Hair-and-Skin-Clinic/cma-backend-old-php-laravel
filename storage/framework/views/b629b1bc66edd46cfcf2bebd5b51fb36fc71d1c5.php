...
<body id="page-top">
    <div id="wrapper">
        ...
        <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
            <a style="color: white;background-color: white;" class="sidebar-brand d-flex align-items-center justify-content-center"
            ...
            <li class="nav-item <?php echo e(Request::is('admin/doctors') ? 'active' : ''); ?>">
                <a class="nav-link" href="<?php echo e(url('admin/doctors')); ?>">
                    ...
                    <span><?php echo e(__('Center/Doctors')); ?></span>
                </a>
            </li>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/berkowits/cma-backend/resources/views/admin/layout.blade.php ENDPATH**/ ?>