                           ...
                           <h4><?php echo e(__('Service Information')); ?></h4>
                                ...
                                <?php elseif(isset($_REQUEST['service']) && isset($_REQUEST['therapist'])&& isset($_REQUEST['date']) ): ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="service_date" id="service_date" value="<?php echo e($_REQUEST['date']); ?>" placeholder="Enter Service Name" disabled>
                                        <input type="hidden" name="therapist" id="therapist" value="<?php echo e($_REQUEST['therapist']); ?>" />
                                        <input type="hidden" name="service" id="service" value="<?php echo e($services->zenoti_service_id); ?>" />
                                        <input type="hidden" name="date" id="date" value="<?php echo e($_REQUEST['date']); ?>" />
                                        ...
                                        <div class="select-box">
                                            <select class="form-control" name="service" id="service" required>
                                                ...
                                                <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($service['zenoti_service_id']); ?>"><?php echo e($service['zenoti_service_name']); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                    </div>
...
<?php echo $__env->make('user.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/berkowits/cma-backend/resources/views/user/booking.blade.php ENDPATH**/ ?>