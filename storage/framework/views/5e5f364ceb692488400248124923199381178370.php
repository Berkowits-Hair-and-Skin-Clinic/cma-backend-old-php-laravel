         ...
         <div class="outer-container">
            <div class="add-listing my-profile">
               <div class="single-box">
                  <div class="title-box">
                     <h3><?php echo e(__("Profile Details")); ?></h3>
                  </div>
                  <div class="title-box">
                     <h3><?php echo e(__("Our Speciality:")); ?></h3>
                     <label><?php echo e($doctordata->speciality); ?></label>
                  </div>
                  <div class="inner-box">
                                    ...
                                    <div class="profile-title">
                                       ...
                                       <div class="map" id="maporder">
                                          <div class="form-group">
                                           ...
                                           <input type="hidden" name="lat" id="us2-lat" value="<?php echo e(isset($doctordata->lat)?$doctordata->lat:$setting->map_lat); ?>" />
                                          <input type="hidden" name="lon" id="us2-lon" value="<?php echo e(isset($doctordata->lon)?$doctordata->lon:$setting->map_long); ?>" />
...
<?php echo $__env->make('user.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/berkowits/cma-backend/resources/views/user/doctor/editprofile.blade.php ENDPATH**/ ?>