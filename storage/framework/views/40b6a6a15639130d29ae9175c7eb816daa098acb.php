      ...
      <div class="content-container">
         <div class="outer-container">
            <div class="feature-content">
               <h3>Video Consultation
               </h3><a class="theme-btn-one"  style="float: right;" href="<?php echo e(url('videoconsultationlist')); ?>" ><i class="fas fa-camera-alt"></i><?php echo e(__(' View List')); ?></a><br /><br /><hr />
                  ...
                  <div class="col-xl-3 col-lg-12 col-md-12 feature-block">
                     <div class="feature-block-two">
                        <div class="inner-box">
                           ...
                           <h3><?php echo e($totalConsultation); ?></h3>
                           <h5><?php echo e(__('Total Consultation')); ?></h5>
                        </div>
                     </div>
                  </div>
                  <div class="col-xl-3 col-lg-12 col-md-12 feature-block">
                  <a href="<?php echo e(url('videoconsultationlist?type=4')); ?>">
                     <div class="feature-block-two">
                        <div class="inner-box">
                           <div class="pattern">
                           ...
                           <h3><?php echo e($totalComplatedConsultation); ?></h3>
                           <h5><?php echo e(__('Completeted')); ?></h5>
                        </div>
                     </div>
                     </a>
                  </div>
                  <div class="col-xl-3 col-lg-12 col-md-12 feature-block">
                  <a href="<?php echo e(url('videoconsultationlist?type=5')); ?>">
                     <div class="feature-block-two">
                        <div class="inner-box">
                           <div class="pattern">
                           ...
                           <h3><?php echo e($totalAbsentConsultation); ?></h3>
                           <h5><?php echo e(__('Absent')); ?></h5>
                        </div>
                     </div>
                     </a>
                  </div>
                  <div class="col-xl-3 col-lg-12 col-md-12 feature-block">
                     <div class="feature-block-two">
                        <div class="inner-box">
                           ...
                           <div class="icon-box"><i class="icon-Dashboard-3"></i></div>
                           <h3><?php echo e($totalPendingConsultation); ?></h3>
                           <h5><?php echo e(__('Pending')); ?></h5>
                        </div>
                     </div>
                  </div>
               </div>
                     ...
                     <table class="doctors-table">
                        <thead class="table-header">
                           <tr>
                              ...
                              <th><?php echo e(__('message.TherapistName')); ?></th>
                            ...
                            <?php $__currentLoopData = $bookdata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
		                           ...
		                           <tr>
		                              <td>
		                                 ...
		                                 <div class="name-box">
                                       <a href="<?php echo e(url('appointment_detail',$bo->id)); ?>">
		                                    <figure class="image">
                                    ...
                                    <?php 
                                    if(!empty($bo->service_therapist_detail) AND $bo->service_therapist_detail!=NULL){
                                       $service_therapist_detail_array=explode(",",$bo->service_therapist_detail);
                                    }else{
                                    ...
                                    ?>
                                    <td><?php echo e($service_therapist_detail_array[0]); ?></td>
                                    <td><?php echo e($service_therapist_detail_array[1]); ?></td>
		                              <td>
		                                 <?php
                                    if($bo->status=='1'){
...
<?php echo $__env->make('user.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/berkowits/cma-backend/resources/views/user/doctor/dashboard.blade.php ENDPATH**/ ?>