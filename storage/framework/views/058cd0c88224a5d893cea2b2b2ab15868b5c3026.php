    ...
    <div class="auto-container">
        ...
        <!--<i class="fa fa-arrow-left" aria-hidden="true"></i>-->
            <div class="content-box">
                <div class="title-box">
                    <h3><?php echo e(__('message.appointment Details')); ?></h3>
                </div>
                <div class="inner">
                    <div class="single-item">
                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#add_Prescription"><?php echo e(__("message.Add Prescription")); ?></button><br><br>
                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#add_report"><?php echo e(__("message.Add Report")); ?></button>
                            </div>
                        </div>

                        <div class="row pt-4">

                            <h4 class="pl-3"><?php echo e(__("message.prescription Details")); ?></h4>
...
<?php echo $__env->make('user.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\rutik\live\bookappointment__medical\resources\views/user/doctor/prescription.blade.php ENDPATH**/ ?>