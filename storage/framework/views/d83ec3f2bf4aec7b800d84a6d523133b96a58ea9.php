...
<head>
    ...
    <script type="text/javascript"
        src='https://maps.google.com/maps/api/js?key=<?php echo e($setting->map_papi_key); ?>&sensor=false&libraries=places'></script>
    ...
    <header class="main-header style-two" style="background-color:#E8C7CF;"> 
        ...
        <div class="header-lower">
            <div class="auto-container">
                <div class="outer-box">
                    <div class="logo-box">
                        <figure class="logo"><a href="<?php echo e(url(env('BERKOWITS_MAIN_SITE'))); ?>"><img
                                    src="<?php echo e(asset('public/image_web/') . '/' . $setting->logo); ?>" alt=""></a>
                        </figure>
                        <!--<figure class="logo"><img
                                    src="<?php echo e(asset('public/image_web/') . '/' . $setting->logo); ?>" alt="Berkowits Logo">
                        </figure>-->
                    </div>
                    <div class="menu-area">
                                ...
                                <ul  class="navigation clearfix">
                                   <!-- <li class="" id="home"><a
                                    ...
                                    <li class="" id="home"><a style="color:black"
                                            href="<?php echo e(url('searchcenterall')); ?>"><?php echo e(__('message.Centre')); ?></a></li>
                                    <!--<li class="" id="home"><a
                                            href="<?php echo e(url('searchcentre')); ?>"><?php echo e(__('message.Centre')); ?></a></li>-->
                                    <!--<li class="" id="home"><a style="color:black"
                                            href="<?php echo e(url('viewspecialist')); ?>"><?php echo e(__('message.Concern')); ?></a></li>-->
                                    <li class="" id="home"><a style="color:black"
                                            href="<?php echo e(url(env('BERKOWITS_MAIN_SITE'))); ?>"><?php echo e(__('Products')); ?></a></li>
                                    <li class="" id="home"><a style="color:black"
                                            href="<?php echo e(env('BERKOWITS_COMMON_CONTACT_PAGE')); ?>"><?php echo e(__('message.Contact Us')); ?></a></li>
                                    <li class="my-account-button" id="home">
                                        <?php if(empty(Session::get('user_id'))): ?>
                                            <a style="color:black" href="<?php echo e(url('auth/loginbyotp')); ?>"><?php echo e(__('Client Login')); ?></a>
                                            <!-- <a style="font-weight: bold;color:black" href="<?php echo e(url('profilelogin')); ?>"><?php echo e(__('Center Login')); ?></a> -->
                                        <?php else: ?>
                                            <?php if(Session::get('user_id') != '' && Session::get('role_id') == 1): ?>
                                                <a style="color:black"
                                                    href="<?php echo e(url('userappointmentdashboard')); ?>"><?php echo e(__('message.My Dashboard')); ?></a>
                                            <?php else: ?>
                                                <a style="color:black"
                                                    href="<?php echo e(url('doctordashboard')); ?>"><?php echo e(__('message.My Dashboard')); ?></a>
                                            <?php endif; ?>
                                        <?php endif; ?>
                                    </li>
                                </ul>
                    ...
                    <div class="btn-box">
                        <?php if(empty(Session::get('user_id'))): ?>
                            <!--<a href="<?php echo e(url('profilelogin')); ?>" class="theme-btn-one">
                            <i class="fas fa-lock"></i><?php echo e(__('message.Employee Login')); ?></a>-->
                            <a href="<?php echo e(url('auth/loginbyotp')); ?>" class="theme-btn-one">
                            <i style="margin-right: 10px;color:black;font-size:larger" class="fas fa-lock"></i><?php echo e(__('message.Client Login')); ?></a>
                        <?php else: ?>
                            <?php if(Session::get('user_id') != '' && Session::get('role_id') == 1): ?>
                                <a href="<?php echo e(url('userappointmentdashboard')); ?>"
                    ...
                    <div class="btn-box">
                        <?php if(empty(Session::get('user_id'))): ?>
                            <!--<a href="<?php echo e(url('profilelogin')); ?>" class="theme-btn-one">
                                <i class="fas fa-lock"></i><?php echo e(__('message.Employee Login')); ?></a>-->
                            <a href="<?php echo e(url('auth/loginbyotp')); ?>" class="theme-btn-one">
                            <i class="fas fa-lock"></i><?php echo e(__('message.Client Login')); ?></a>
                        <?php else: ?>
                            <?php if(Session::get('user_id') != '' && Session::get('role_id') == 1): ?>
                                <a href="<?php echo e(url('userappointmentdashboard')); ?>"
                                    class="theme-btn-one"><?php echo e(__('message.My Dashboard')); ?></a>
        ...
        <nav class="menu-box" style="background-color:#E8C7CF;">
            ...
            <div class="contact-info" style="color:black">
                ...
                <ul style="font-weight: bold;color:black">
                    <li style="font-weight: bold;color:black"><?php echo e($setting->address); ?></li>
                    <li><a style="font-weight: bold;color:black" href="tel:<?php echo e($setting->phone); ?>"><?php echo e($setting->phone); ?></a></li>
                    <li><a style="font-weight: bold;color:black" href="mailto:<?php echo e($setting->email); ?>"><?php echo e($setting->email); ?></a></li>
                </ul>
            </div>
                            ...
                            <div class="footer-widget links-widget">
                                ...
                                <div class="widget-content">
                                    <ul class="links clearfix">
                                        ...
                                        <li><a href="<?php echo e(env('BERKOWITS_COMMON_CONTACT_PAGE')); ?>"><?php echo e(__('message.Contact Us')); ?></a></li>
                            ...
                            <div class="footer-widget links-widget">
                                ...
                                <div class="widget-content">
                                    <ul class="links clearfix">
                                        ...
                                        <li><a href="<?php echo e(url('searchcenterall')); ?>"><?php echo e(__('message.Doctors')); ?></a></li>
                                        <li><a
                                                href="<?php echo e(url('searchcentre')); ?>"><?php echo e(__('message.Search Centre')); ?></a>
                                        </li>
                                        <li><a href="<?php echo e(url('profilelogin')); ?>" class="theme-btn">
                                        <i class="fas fa-lock"></i><?php echo e(__('message.Employee Login')); ?></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/berkowits/cma-backend/resources/views/user/layout.blade.php ENDPATH**/ ?>