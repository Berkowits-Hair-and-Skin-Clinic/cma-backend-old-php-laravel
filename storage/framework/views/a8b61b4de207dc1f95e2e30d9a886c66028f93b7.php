...
<script>
      ...
      {
        var x = confirm('<?php echo e(__("message.Are you sure active this subscription")); ?>');
        if(x){
             $.ajax({
  ...
  {
    var x = confirm('<?php echo e(__("message.Are you sure disable this subscription")); ?>');
    if(x){
      $.ajax({
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\rutik\live\bookappointment__medical\resources\views/admin/subscription/subscriber_doc.blade.php ENDPATH**/ ?>