                        ...
                        <div class="appointment-list">
                            ...
                            <div class="upper-box clearfix">
                                ...
                                <div class="select-box pull-right">
                                    <select onchange="filterbystatus(this.value)" class="custom-dropdown" style="width: 100%;border: 1px solid #ada3a3;padding: 15px 30px;border-radius: 15px;">
...
<script type="text/javascript">
        function filterbystatus(val) {
            window.location.href = '<?php echo e(url('doctorappointment')); ?>' + '?filterbystatus=' + val;

        }
    </script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('user.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/berkowits/cma-backend/resources/views/user/doctor/appointmentlist.blade.php ENDPATH**/ ?>