            ...
            <div class="auto-container">
                <div class="inner-box">
                    <div class="content-box">
                        <div class="title-box">
                            <h3><?php echo e(__('Client Login')); ?></h3>
                            <a href="<?php echo e(url('clientregister')); ?>"><?php echo e(__('message.Register Now')); ?></a>
                        </div>
                        <div class="inner">
                            ...
                            <?php endif; ?>
                            <div id="error"></div>
                            <!--<?php echo e(Session::get('user_phone_no')); ?>-->
                            <?php if(Session::get('user_id') != '' && Session::get('role_id') == 1): ?>
                                <script type="text/javascript">
                                    window.location = "<?php echo e(url('/userdashboard')); ?>";//here double curly bracket
                                </script>
                             <?php endif; ?>
                             <?php if(Session::get('user_id') != '' && Session::get('role_id') == 2): ?>
                                <script type="text/javascript">
                                    window.location = "<?php echo e(url('/doctordashboard')); ?>";//here double curly bracket
                                </script>
                             <?php endif; ?>
                             <?php if(Session::get('user_id') != '' && Session::get('role_id') == 3): ?>
                                <script type="text/javascript">
                                    window.location = "<?php echo e(url('/pharmacydashboard')); ?>";//here double curly bracket
                                </script>
                             <?php endif; ?>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 form-group message-btn">
                                <a style="width: 100%;" href="<?php echo e(url('auth/loginbyotp')); ?>" class="theme-btn-one">Login By OTP <i class="icon-Arrow-Right"></i></a>
                            </div>
...
<?php echo $__env->make('user.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/berkowits/cma-backend/resources/views/user/patient/login.blade.php ENDPATH**/ ?>