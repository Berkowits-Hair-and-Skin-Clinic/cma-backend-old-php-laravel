...
class AuthenticationController extends Controller
{
    ...
    public function showdashboard()
    {
        ...
        return view("admin.dashboard")->with('dashboard_counters',$dashboard_counters)->with('totalvc',$totalvc)->with('totalai_analysis',$totalai_analysis)->with("months", $months)->with("earnings", $earnings)->with("pharmacy", $pharmacy)->with("totaldoctor", $totaldoctor)->with("totalpharmacy", $totalpharmacy)->with("totalpharmacyorder", $totalpharmacyorder)->with("totalappointment", $totalappointment)->with("totalreview", $totalreview)->with("totalpatient", $totalpatient);
    }
